...
class _$_Person with DiagnosticableTreeMixin implements _Person {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Person(firstName: $firstName, lastName: $lastName, age: $age, birthYear: $birthYear)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, firstName, lastName, age, birthYear);
...
abstract class _Person implements Person {
  const factory _Person(
      ...
      @JsonKey(name: 'birth_year') final int? birthYear}) = _$_Person;
